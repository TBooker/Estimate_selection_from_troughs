...
rawBoots <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BimodalSims.csv')
...
rawSims1 <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BGS+SWEEPS/BimodalDFE.analysis.txt')
...
rawSims2 <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BGS+SWEEPS/BimodalDFE_div10.analysis.txt')
...
rawSims3 <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BGS+SWEEPS/BimodalDFE_div100.analysis.txt')
...
rawBoots <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/expSims.csv')
rawBoots$product <- rawBoots$NeSa * rawBoots$pa
str(rawBoots)
Boots<-melt(rawBoots, id = c('identifier'))

rawSims1 <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BGS+SWEEPS/Exp.Nes10_dDFE.Exponential_div10.analysis.txt')
rawSims1$product <- rawSims1$NeSa * rawSims1$pa
Sims1<-melt(rawSims1, id = c('identifier','X','rep', 'AIC'))
Sims1$identifier <- 'Exp10 - div10'

rawSims2 <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BGS+SWEEPS/Exp.Nes10_dDFE.Exponential.analysis.txt')
rawSims2$product <- rawSims2$NeSa * rawSims2$pa
Sims2<-melt(rawSims2, id = c('identifier','X','rep', 'AIC'))
Sims2$identifier <- 'Exp10'

rawSims3 <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BGS+SWEEPS/Exp.Nes100_dDFE.Exponential_div10.analysis.txt')
rawSims3$product <- rawSims3$NeSa * rawSims3$pa
Sims3<-melt(rawSims3, id = c('identifier','X','rep', 'AIC'))
Sims3$identifier <- 'Exp100 - div10'

rawSims4 <- read.csv('~/PhD/Coding/Estimate_selection_from_troughs/simulations/analysis/BGS+SWEEPS/Exp.Nes100_dDFE.Exponential.analysis.txt')
rawSims4$product <- rawSims4$NeSa * rawSims4$pa
Sims4<-melt(rawSims4, id = c('identifier','X','rep', 'AIC'))
