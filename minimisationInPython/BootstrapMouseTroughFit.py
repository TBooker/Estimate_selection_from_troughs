...
## read in the three big dataframes
	dataMaster1 = pd.read_csv(args.input[0])
	dataMaster2 = pd.read_csv(args.input[1])
	dataMaster3 = pd.read_csv(args.input[2])
...
## Print a report of the final result, comment out when performing bootstraps other wise it will spew tons of stuff to the stdout 
